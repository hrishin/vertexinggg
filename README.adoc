= REST API Level 0 - Eclipse Vert.x Boosterasdasdasdasd 1232 24234234

IMPORTANT: This booster requires Java 8 JDK or greater and Maven 3.3.x or greater.asdasd
...
----
$ git clone git@github.com:hrishin/vertexinggg
